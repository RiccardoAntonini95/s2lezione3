...
for(let i = 0; i < starWarsCharacters.length; i++){
  let personaggi = starWarsCharacters[i]
  characters.push = personaggi.name
} 
...
for(let i = 0; i < starWarsCharacters.length; i++){
  let donne = starWarsCharacters[i]
  if(donne.gender === "female"){
  femaleCharacters.push = donne
  }
}
...
while(i < starWarsCharacters.length)  {
  let personaggi = starWarsCharacters[i];
  crewMass = crewMass + personaggi.mass;
  i++;
}
